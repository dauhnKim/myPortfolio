  ...
  return (
    <main className="work_main">
      <div className="work_container">
        <h1>Work</h1>
        <h2>
          <a target="_blank" href="https://dauhnkim.github.io/portfolio/">
            Portfolio Ver.01
          </a>
        </h2>
        {/* <a target="_blank" href="https://dauhnkim.github.io/portfolio/">
        ...
        <ul className="work_explain">
          <li>REACT &middot; REACT NATIVE</li>
          <li>VUE &middot; TYPESCRIPT</li>
          <li>HTML5 &middot; CSS3</li>
          <li>
      ...
      <div className="work_photo">
        ...
        <p className="description">
          ...
          <br /> While I was building this, it got me familiar with using basic
          JS.
        </p>
